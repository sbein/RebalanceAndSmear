...
python tools/ahadd.py -f Vault/NonQcd_LDP_MC2018.root output/*/*MC2017_LDP.root
python tools/ahadd.py -f Vault/NonQcdZJets_LDP_MC2018.root output/ZJets/*MC2017_LDP.root
python tools/ahadd.py -f Vault/NonQcd_signalSideband_MC2018.root output/*/*MC2017_signalSideband.root
python tools/ahadd.py -f Vault/NonQcdZJets_signalSideband_MC2018.root output/ZJets/*MC2017_signalSideband.root
